...
export default function OverviewPage() {
  ...
  return (
    <div className={'static h-screen'}>
      <div className={''}>
        <div className={'flex flex-col overflow-y-auto print:overflow-clip md:p-2 p-0 print:p-0 rounded-xl space-y-2'}>
          {loading ? (
            <PageCenter>
              <Loading />
            </PageCenter>
            ...
            selectedCard?.groups
              ...
              .map((group) => (
                <div
                  ...
                  className={'border md:border-base-200 md:rounded-xl rounded-none p-1 print:p-1'}
                >
