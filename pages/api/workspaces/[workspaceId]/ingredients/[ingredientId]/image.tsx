...
const legacyHandler = withHttpMethods({
  [HTTPMethod.GET]: withWorkspacePermission([Role.USER], Permission.INGREDIENTS_READ, async (req: NextApiRequest, res: NextApiResponse, user, workspace) => {
...
export default withDeprecation({ successor: '/api/v1/workspaces/{workspaceId}/ingredients/{ingredientId}/image' }, legacyHandler);
